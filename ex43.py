...
class Death(Scene):
    ...
    quips = [
        ...
        "Such a luser.",
        "I have a smol puppy that's better at this.",
    ...
    def enter(self):
        ...
        if action == "shoot!":
            print(dedent("""
                ...
                misses him entirely. This completely ruis his brand new costume
                his mother bought him, which makes him fly into an insane rage
                and blast you repeatedly in the face until you are dead. Then he
                eats you.
            """))
            return 'death'
            ...
            print(dedent("""
                ...
                jura fur fvfg nebhaq gur ubhfr, fur fvfg nebhaq gur ubhfr. The
                ...
                in the head putting him down, then jump throuch the Weapon
                Armory door.
            """))
...
class LaserWeaponArmory(Scene):
    ...
    def enter(self):
        print(dedent("""
            ...
            for more Gothons that mught be hiding. It's dead quiet, too quiet.
            You stand up and run to the far side of the room and find the
            neutron bomb in its container. There's a keypad lock on the box and
            you need the code to get the bomb out. If you get the code wrong 20
        ...
        while guess != code and guesses <= 20:
            difference = abs(int(guess) - int(code))

            if difference < prev_difference:
                print("BZZZZZEDDD! (hot)")
                prev_difference = difference

            elif difference > prev_difference:
                print("BZZZZZEDDD! (cold)")
                prev_difference = difference
    ...
    def enter(self):
        ...
        if action == "throw the bomb":
            print(dedent("""
                ...
                right in the back killing you. As you die you see a Gothon
                frantically try to disarm the bomb. You die knowing they will
                probably blow up whn it goes off.
            """))

        elif action == "slowly place the bomb":
            print(dedent("""
                You point your blaster at the bomb under your arm and the
                Gothons put their hands up and start to sweat. You inch backward
                to the door, open it, and then carefully place the bomb on the
                floor, pointing your blaster at it. You then jump back through
                the door, punch the close button and blast the lock so the
                Gothons can't get out. Now the bomb is placed you run to the
...
class EscapePod(Scene):
    ...
    def enter(self):
        ...
        if int(guess) != good_pod and guess != "007":
            print(dedent(f"""
                You jump into pod {good_pod} and hit the eject button. The pod
            ...
            print(dedent(f"""
                You jump into pod {good_pod} and hit the eject button. The pod
                easily slides out into space heading to the planet below. As it
                flies to the planet, you look back and see your ship implode
                then explode like a bright star, taking out the Gothon ship at
